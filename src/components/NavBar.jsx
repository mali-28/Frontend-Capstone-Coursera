...
export default function NavBar() {
    return (
        <header className="py-2 w-8/12 mx-auto px-2 bg-white border-gray-200  dark:border-gray-700">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <nav className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
